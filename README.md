...
- اعلان با پنجره سفارشی گوشه پایین-راست (دکمه‌های «متوجه شدم» / «مشاهده» / «بعداً») در همه نسخه‌ها یکسان.
...
- `Dev`: فقط `true` آیکون Tray (منوی بررسی دستی/خروج) نشان می‌دهد. در حالت عادی کاملاً مخفی است.
...
## جلوگیری از تکرار
- «متوجه شدم» یا «مشاهده» → تایید روی سرور و محلی؛ دیگر هرگز نمایش داده نمی‌شود.
- «بعداً» یا بسته شدن خودکار (۶۰ ثانیه) → ۲۴ ساعت بعد دوباره یادآوری می‌شود.
